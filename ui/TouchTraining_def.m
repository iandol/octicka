...
function ret = show_TouchTraining(varargin)
  ...
  _xPos = (_scrSize(3) - 906)/2;
  _yPos = (_scrSize(4) - 587)/2;
   TouchTraining = figure ( ... 
	'Color', [0.937 0.937 0.937], ...
	'Position', [_xPos _yPos 906 587], ...
	'resize', 'off', ...
	'windowstyle', 'normal', ...
	'MenuBar', 'none');
