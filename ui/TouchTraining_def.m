...
set(TouchTraining.Phase,'String',num2str(d.data.phase(end)))
...
function ret = show_TouchTraining(varargin)
  ...
  _xPos = (_scrSize(3) - 914)/2;
  _yPos = (_scrSize(4) - 615)/2;
   TouchTraining = figure ( ...
	'Color', [0.937 0.937 0.937], ...
	'Position', [_xPos _yPos 914 615], ...
	'resize', 'off', ...
	'windowstyle', 'normal', ...
	'MenuBar', 'none');
  ...
  Task = uicontrol( ...
	...
	'FontWeight', 'normal', ...
	'ForegroundColor', [0.000 0.000 0.000], ...
	'Position', [10 93 290 47], ...
	'String', 'Standard|Simple', ...
	'TooltipString', '', ...
	'visible', 'on');
  Label_8 = uicontrol( ...
	'parent',Settings, ...
