...
function ret = show_TouchTraining(varargin)
  ...
  _xPos = (_scrSize(3) - 913)/2;
  _yPos = (_scrSize(4) - 694)/2;
   TouchTraining = figure ( ... 
	'Color', [0.937 0.937 0.937], ...
	'Position', [_xPos _yPos 913 694], ...
	'resize', 'off', ...
	'windowstyle', 'normal', ...
	'MenuBar', 'none');
